    ...
    return (
        <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
            ...
            <div className="w-full">
                ...
                value={name}
                className="w-full max-w-96 px-3 py-2" type="text" placeholder="Type here" required/>
            </div>
            ...
            <div className="w-full">
                ...
                value={description}
                className="w-full max-w-96 px-3 py-2 " type="text" placeholder="Write description" required/>
            </div>
            ...
            <button className="w-28 py-2 rounded-md hover:bg-gray-700 mt-4 bg-black text-white" type="submit">ADD</button>
